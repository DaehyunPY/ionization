...
COMMON_MOD3 += global.f90 hamiltonian.f90 basis.f90 boundary.f90 asymptote.f90 main.f90 
...
# gsl library:
# FFLAGS  += -I/usr/include
FFLAGS  += -I/usr/local/include/fgsl
# LDFLAGS += -L/usr/lib
LDFLAGS += -lfgsl 
...
# my library: 
FFLAGS  += -I/users/hyuna917/dropbox/library/fortran/include
# FFLAGS  += -I/users/hyuna917/dropbox/library/fortran/include/gnu 
# LDFLAGS += -L/users/hyuna917/dropbox/library/fortran/lib/intel
# LDFLAGS += -L/users/hyuna917/dropbox/library/fortran/lib/gnu 
LDFLAGS += ~/dropbox/library/fortran/lib/liblinear.a 
LDFLAGS += ~/dropbox/library/fortran/lib/libplot.a 
...
main.o: 		 global.o hamiltonian.o basis.o boundary.o asymptote.o 
