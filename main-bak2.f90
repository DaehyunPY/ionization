program main
    ...
    use asymptote,   only: PROC_CS_plot, PROC_CS_achive, PROC_PS_achive, PROC_E_vs_CS_plot, PROC_E_vs_PS_plot
    implicit none
    ...
    do j = 1, M 
        ...
        do i = 0, L 
            ...
            write(file_log, form_round) "ANGULAR MOMANTUM ", i, "SCATTERING ENERGY ", coord_E(j)
                ...
                if((op_dcs == "Y" .or. op_inner == "Y" .or. op_outer == "Y") &
                    .or. (op_tcs == "Y" .or. op_ps == "Y")) & 
